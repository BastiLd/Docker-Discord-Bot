...
- `0.1.4` for the fixed app-store style version.
...
If you use tag `main`, the tag moves after every successful workflow run. If you use tag `0.1.4`, bump the version in `.github/workflows/docker-image.yml` and `appstore/homelab-discord-bot-manager/docker-compose.yml` when you want a real release.
